# Comparing `tmp/myfunction_ilonaserg-0.0.2.tar.gz` & `tmp/myfunction_ilonaserg-0.0.3.tar.gz`
...
## Comparing `myfunction_ilonaserg-0.0.2.tar` & `myfunction_ilonaserg-0.0.3.tar`
...
### Comparing `myfunction_ilonaserg-0.0.2/setup.py` & `myfunction_ilonaserg-0.0.3/setup.py`
