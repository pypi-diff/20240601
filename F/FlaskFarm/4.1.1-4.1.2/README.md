# Comparing `tmp/FlaskFarm-4.1.1.tar.gz` & `tmp/FlaskFarm-4.1.2.tar.gz`
...
### Comparing `FlaskFarm-4.1.1/FlaskFarm.egg-info/SOURCES.txt` & `FlaskFarm-4.1.2/FlaskFarm.egg-info/SOURCES.txt`
...
### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/mod_tool.py` & `FlaskFarm-4.1.2/flaskfarm/lib/system/mod_tool.py`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/page_command.py` & `FlaskFarm-4.1.2/flaskfarm/lib/system/page_command.py`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/setup.py` & `FlaskFarm-4.1.2/flaskfarm/lib/system/setup.py`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_all_log.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_all_log.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_home.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_home.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_login.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_login.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_plugin_list.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_plugin_list.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_restart.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_restart.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_setting_auth.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_setting_auth.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_setting_basic.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_setting_basic.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_setting_celery.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_setting_celery.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_setting_config.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_setting_config.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_setting_export.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_setting_export.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_setting_menu.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_setting_menu.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_setting_notify.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_setting_notify.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_setting_web.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_setting_web.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_tool_command.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_tool_command.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_tool_crypt.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_tool_crypt.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_tool_python.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_tool_python.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/system/templates/system_tool_upload.html` & `FlaskFarm-4.1.2/flaskfarm/lib/system/templates/system_tool_upload.html`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/tool/fp_entity_ktv.py` & `FlaskFarm-4.1.2/flaskfarm/lib/tool/fp_entity_ktv.py`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/tool/modal_command.py` & `FlaskFarm-4.1.2/flaskfarm/lib/tool/modal_command.py`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/tool/notify.py` & `FlaskFarm-4.1.2/flaskfarm/lib/tool/notify.py`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/lib/tool/util.py` & `FlaskFarm-4.1.2/flaskfarm/lib/tool/util.py`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/flaskfarm/main.py` & `FlaskFarm-4.1.2/flaskfarm/main.py`

 * *Files identical despite different names*

### Comparing `FlaskFarm-4.1.1/setup.py` & `FlaskFarm-4.1.2/setup.py`
