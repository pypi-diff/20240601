# Comparing `tmp/composio_crewai-0.3.2.tar.gz` & `tmp/composio_crewai-0.3.3.tar.gz`
...
## Comparing `composio_crewai-0.3.2.tar` & `composio_crewai-0.3.3.tar`
...
### Comparing `composio_crewai-0.3.2/PKG-INFO` & `composio_crewai-0.3.3/PKG-INFO`
...
### Comparing `composio_crewai-0.3.2/README.md` & `composio_crewai-0.3.3/README.md`

 * *Files identical despite different names*

### Comparing `composio_crewai-0.3.2/composio_crewai.egg-info/PKG-INFO` & `composio_crewai-0.3.3/composio_crewai.egg-info/PKG-INFO`
...
### Comparing `composio_crewai-0.3.2/setup.py` & `composio_crewai-0.3.3/setup.py`
