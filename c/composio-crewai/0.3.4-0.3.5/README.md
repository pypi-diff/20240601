# Comparing `tmp/composio_crewai-0.3.4.tar.gz` & `tmp/composio_crewai-0.3.5.tar.gz`
...
## Comparing `composio_crewai-0.3.4.tar` & `composio_crewai-0.3.5.tar`
...
### Comparing `composio_crewai-0.3.4/PKG-INFO` & `composio_crewai-0.3.5/PKG-INFO`
...
### Comparing `composio_crewai-0.3.4/README.md` & `composio_crewai-0.3.5/README.md`

 * *Files identical despite different names*

### Comparing `composio_crewai-0.3.4/composio_crewai.egg-info/PKG-INFO` & `composio_crewai-0.3.5/composio_crewai.egg-info/PKG-INFO`
...
### Comparing `composio_crewai-0.3.4/setup.py` & `composio_crewai-0.3.5/setup.py`
