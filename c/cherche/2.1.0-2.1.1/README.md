# Comparing `tmp/cherche-2.1.0.tar.gz` & `tmp/cherche-2.1.1.tar.gz`
...
### Comparing `cherche-2.1.0/LICENSE` & `cherche-2.1.1/LICENSE`
...
### Comparing `cherche-2.1.0/README.md` & `cherche-2.1.1/README.md`
