# Comparing `tmp/tui_dsmt-202406011310.tar.gz` & `tmp/tui_dsmt-202406011525.tar.gz`
...
## Comparing `tui_dsmt-202406011310.tar` & `tui_dsmt-202406011525.tar`
...
### Comparing `tui_dsmt-202406011310/PKG-INFO` & `tui_dsmt-202406011525/PKG-INFO`
...
### Comparing `tui_dsmt-202406011310/setup.py` & `tui_dsmt-202406011525/setup.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/__init__.py` & `tui_dsmt-202406011525/src/tui_dsmt/__init__.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/clustering/PAM.py` & `tui_dsmt-202406011525/src/tui_dsmt/clustering/PAM.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/clustering/animation.py` & `tui_dsmt-202406011525/src/tui_dsmt/clustering/animation.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/clustering/datasets.py` & `tui_dsmt-202406011525/src/tui_dsmt/clustering/datasets.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/clustering/evaluation.py` & `tui_dsmt-202406011525/src/tui_dsmt/clustering/evaluation.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/clustering/hierarchical.py` & `tui_dsmt-202406011525/src/tui_dsmt/clustering/hierarchical.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/clustering/interactive.py` & `tui_dsmt-202406011525/src/tui_dsmt/clustering/interactive.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/BruteForceFI.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/BruteForceFI.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/ConditionalFPTree.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/ConditionalFPTree.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/ConditionalPatternBase.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/ConditionalPatternBase.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/FPTree.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/FPTree.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/HashTree.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/HashTree.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/Itemset.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/Itemset.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/ItemsetGrid.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/ItemsetGrid.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/ItemsetGridApriori.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/ItemsetGridApriori.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/ItemsetGridECLAT.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/ItemsetGridECLAT.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/SequentialDatabase.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/SequentialDatabase.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/SequentialItemset.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/SequentialItemset.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/TransactionDatabase.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/TransactionDatabase.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/__init__.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/__init__.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/datasets.py` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/datasets.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/resources/website_tracking.csv` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/resources/website_tracking.csv`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/fpm/resources/website_tracking2.json` & `tui_dsmt-202406011525/src/tui_dsmt/fpm/resources/website_tracking2.json`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/BFS.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/BFS.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/BipartiteFlow.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/BipartiteFlow.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/BronKerbosch.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/BronKerbosch.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/DFS.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/DFS.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/Dijkstra.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/Dijkstra.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/FordFulkerson.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/FordFulkerson.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/FruchtermanReingold.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/FruchtermanReingold.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/Hall.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/Hall.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/InteractiveGraph.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/InteractiveGraph.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/Kruskal.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/Kruskal.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/LabelPropagation.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/LabelPropagation.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/MaximumFlow.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/MaximumFlow.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/RandomWalk.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/RandomWalk.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/__init__.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/__init__.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/datasets.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/datasets.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/game.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/game.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/html.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/html.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/representation.py` & `tui_dsmt-202406011525/src/tui_dsmt/graph/representation.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/graph/resources/dewiki_sample.pickle.bz2` & `tui_dsmt-202406011525/src/tui_dsmt/graph/resources/dewiki_sample.pickle.bz2`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/jpanim/JupyterAnimation.py` & `tui_dsmt-202406011525/src/tui_dsmt/jpanim/JupyterAnimation.py`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/jpanim/resources/controls-ff.html` & `tui_dsmt-202406011525/src/tui_dsmt/jpanim/resources/controls-ff.html`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/jpanim/resources/controls.html` & `tui_dsmt-202406011525/src/tui_dsmt/jpanim/resources/controls.html`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/jpanim/resources/script.js` & `tui_dsmt-202406011525/src/tui_dsmt/jpanim/resources/script.js`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt/jpanim/resources/vue-3.4.24.js` & `tui_dsmt-202406011525/src/tui_dsmt/jpanim/resources/vue-3.4.24.js`

 * *Files identical despite different names*

### Comparing `tui_dsmt-202406011310/src/tui_dsmt.egg-info/PKG-INFO` & `tui_dsmt-202406011525/src/tui_dsmt.egg-info/PKG-INFO`
...
### Comparing `tui_dsmt-202406011310/src/tui_dsmt.egg-info/SOURCES.txt` & `tui_dsmt-202406011525/src/tui_dsmt.egg-info/SOURCES.txt`
